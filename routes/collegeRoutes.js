...
import {getAllColleges,getCollege,updateCollege,deleteCollege, addCollege, ListUsersFromCollege, ListCollegesFromUser, updateCollegeAvatar, getCollegeLists, pendingCollegeRequest, acceptCollegeRequest, createCollegeRequest} from '../controllers/collegeController.js'

router.route("/").get(getAllColleges);

router.route("/").post(createCollegeRequest);
